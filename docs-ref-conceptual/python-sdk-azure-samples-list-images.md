...
ms.locfileid: "20909032"
---
# <a name="list-images"></a><span data-ttu-id="c115b-103">Répertorier des images</span><span class="sxs-lookup"><span data-stu-id="c115b-103">List images</span></span>

<span data-ttu-id="c115b-104">Le code suivant permet d’imprimer toutes les images à utiliser pour créer des machines, toutes références (SKU) et versions disponibles comprises.</span><span class="sxs-lookup"><span data-stu-id="c115b-104">Use the following code to print all of the available images to use for creating virtual machines, including all skus and versions.</span></span>
